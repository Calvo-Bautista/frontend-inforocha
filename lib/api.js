 ...
 * NOTE: During migration, localStorage is used as fallback. Cookie HttpOnly is primary.
 */
const getToken = () => {
...
export const authAPI = {
  ...
  /**
   * Logout - clear HttpOnly cookie via backend + clear localStorage fallback
   */
  logout: async () => {
    try {
...
export const usersAPI = {
  ...
  /**
   * Get user stats (global count by role)
   * @returns {Promise<Object>} { vendedor, logistica, admin, owner }
   */
  getStats: async () => {
